...
ms.locfileid: "145195493"
---
# <a name="ai-102-ai-engineer"></a>AI-102：AI 工程師

此存放庫包含 Microsoft 官方課程 AI-102 中使用的實驗室指示和檔案。
...
- 講師資料仍然會成為您教導課程內容的主要來源。

- GitHub 上的這些檔案已設計成要在課程實驗室中使用，並使用託管的實驗室環境。

- 建議訓練員每次授課時檢查 GitHub 所做任何變更，以支援最新的 Azure 服務，並在他們授課時獲得最新檔案。
